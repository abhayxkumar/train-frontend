...
}, [trainId, sleeper, ac3, ac2, ac1, psleeper, pac3, pac2, pac1, name, from, to]);
           ...
           <h2 class="ui center aligned icon header">
            ...
            <div class="ui form">
                 <div class="fields">
                    ...
                    <div class="field">
                          <label>No. of Sleeper Class Seats</label>
                               <input type="number"
                    ...
                    <div class="field">
                          <label>No. of 3AC Class Seats</label>
                               <input type="number" 
                               placeholder="3A"
            ...
            <div class="ui form">
                 <div class="fields">
                    <div class="field">
                          <label>No. of 2AC Class Seats</label>
                               <input type="number"
                                placeholder="2A"
                    ...
                    <div class="field">
                          <label>No. of 1AC Class Seats</label>
                               <input type="number" 
                               placeholder="1A"
            ...
            <button  onClick={(e)=>saveTrain(e)} class="ui primary button" disabled={!isFormValid}>
                          Save
             </button>
